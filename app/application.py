...
dict['kern_wellmap'] = "Kern County Wells"
dict['valleywater_pondmap'] = "Valley Water Ponds"
            ...
            html.A(
                ...
                dbc.Row(
                    [
                        ...
                        dbc.Col(dbc.NavbarBrand("Kern County Maps", className="ms-2")),
                    ],
                    align="center",
                    className="g-0",
                ),
...
def render_page_content(pathname):
    if pathname in ["/"]:
        ...
        mymap = "./app/static/valleywater_pondmap.html"
        return html.Div(
